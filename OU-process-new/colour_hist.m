...
A = 0.75; % non-dimensional forcing amplitude
A_n0 = 0.1; %additive noise factor
m = 0; %multiplicative noise
tau =1;%correlation time - 0.01, 0.1, 0, 1, 10
...
tt15=tf(10000:end); %discard first few iterates manually
A15 = A;
figure
hold on
dh = 0.01;
x = 0:dh:1.5;
pdKern15 = fitdist(tt15', 'kernel')
p15 = pdf(pdKern15, x)
plot(x,p15,'LineWidth', 2)
h15 = histogram(tt15,'Normalization','pdf')
hold off
xlabel("{\Delta t_m}")
ylabel("pdf")
% figure
