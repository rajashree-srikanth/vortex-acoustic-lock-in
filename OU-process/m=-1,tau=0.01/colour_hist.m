...
A = 1.0; % non-dimensional forcing amplitude
A_n0 = 0.02;
m = -1;
tau =0.01;%correlation time - 0.01, 0.1, 0, 1, 10
...
tt21=tf(10000:end); %discard first few iterates manually
A21 = A;
figure
hold on
dh = 0.01;
x = 0:dh:1.5;
pdKern21 = fitdist(tt21', 'kernel')
p21 = pdf(pdKern21, x)
