...
A = 0.60; % non-dimensional forcing amplitude
A_n0 = 0.02;
m = -1;
...
tt13=tf(10000:end); %discard first few iterates manually
A13 = A;
figure
hold on
dh = 0.01;
x = 0:dh:1.5;
pdKern13 = fitdist(tt13', 'kernel')
p13 = pdf(pdKern13, x)
plot(x,p13,'LineWidth', 2)
h13 = histogram(tt13,'Normalization','pdf')
hold off
xlabel("{\Delta t_m}")
ylabel("pdf")
% figure
